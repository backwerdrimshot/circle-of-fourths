...
export function posterGeometry(size = "letter") {
  ...
  const nodes = getPosterPositions().map((key, index) => {
    ...
    if (key.spellings.length === 2) {
      ...
      // compressing the major/minor labels or the two scale-note sequences.
